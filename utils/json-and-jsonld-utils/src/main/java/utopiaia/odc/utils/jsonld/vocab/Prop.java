...
package utopiaia.odc.utils.jsonld.vocab;
...
public class Prop {
     ...
     */
    @UtilityClass
    public class UtopiaiaDcatExt {
        public final String CTX = "https://semantic.utopiaia.com/dcat-ext#";
        ...
        public static final class HttpDatasourceHints {
            private HttpDatasourceHints() {}
            public static final String METHOD = CTX + "httpDatasourceHintsProxyMethod";
