...
package utopiaia.odc.extension.messenger.demo;
...
import utopiaia.odc.extension.messenger.SovityMessengerException;
import utopiaia.odc.extension.messenger.demo.message.Addition;
import utopiaia.odc.extension.messenger.demo.message.Answer;
import utopiaia.odc.extension.messenger.demo.message.Counterparty;
import utopiaia.odc.extension.messenger.demo.message.Failing;
import utopiaia.odc.extension.messenger.demo.message.Signal;
import utopiaia.odc.extension.messenger.demo.message.Sqrt;
import utopiaia.odc.extension.messenger.demo.message.UnregisteredMessage;
...
class SovityMessengerDemoTest {
    ...
    void demo() {
         ...
         * in an extension.
         *
         * This messenger is already configured to accept messages in utopiaia.odc.extension.messenger.demo.SovityMessengerDemo#initialize
         */
