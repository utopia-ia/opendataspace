...
import static utopiaia.odc.ext.wrapper.api.common.mappers.asset.utils.JsonBuilderUtils.addNonNull;
import static utopiaia.odc.ext.wrapper.api.common.mappers.asset.utils.JsonBuilderUtils.addNonNullJsonValue;
import static utopiaia.odc.ext.wrapper.api.common.mappers.asset.utils.JsonBuilderUtils.addNotBlank;
import static utopiaia.odc.ext.wrapper.api.common.mappers.asset.utils.JsonBuilderUtils.addNotBlankStringArray;
...
public class AssetJsonLdBuilder {
    ...
    private JsonObject getAssetProperties(
        ...
        addNonNull(properties, Prop.UtopiaiaDcatExt.CUSTOM_JSON, request.getCustomJsonAsString());
