...
import utopiaia.odc.ext.wrapper.api.common.model.DataSourceAvailability;
import utopiaia.odc.ext.wrapper.api.common.model.UiAsset;
import utopiaia.odc.utils.JsonUtils;
import utopiaia.odc.utils.jsonld.JsonLdUtils;
import utopiaia.odc.utils.jsonld.vocab.Prop;
import utopiaia.odc.utils.jsonld.vocab.Prop.UtopiaiaDcatExt.HttpDatasourceHints;
...
public class AssetJsonLdParser {
    ...
    public UiAsset buildUiAsset(JsonObject assetJsonLd, String connectorEndpoint, String participantId) {
        ...
        uiAsset.setOnRequestContactEmail(JsonLdUtils.string(properties, Prop.UtopiaiaDcatExt.CONTACT_EMAIL));
        uiAsset.setOnRequestContactEmailSubject(
            JsonLdUtils.string(properties, Prop.UtopiaiaDcatExt.CONTACT_PREFERRED_EMAIL_SUBJECT)
        );
        ...
        uiAsset.setCustomJsonAsString(JsonLdUtils.string(properties, Prop.UtopiaiaDcatExt.CUSTOM_JSON));
        ...
        uiAsset.setPrivateCustomJsonAsString(JsonLdUtils.string(privateProperties, Prop.UtopiaiaDcatExt.PRIVATE_CUSTOM_JSON));
    ...
    private String getCustomJsonLd(JsonObject properties) {
        ...
        val remaining = removeHandledProperties(properties, List.of(
            ...
            Prop.UtopiaiaDcatExt.CUSTOM_JSON,
    ...
    private String getPrivateCustomJsonLd(JsonObject privateProperties) {
        var remaining = removeHandledProperties(privateProperties, List.of(
            Prop.UtopiaiaDcatExt.PRIVATE_CUSTOM_JSON
        ));
        return packAndSerializeJsonLd(remaining);
    }
    ...
    private DataSourceAvailability getDataSourceAvailability(JsonObject properties) {
        var typeValue = JsonLdUtils.string(properties, Prop.UtopiaiaDcatExt.DATA_SOURCE_AVAILABILITY);
        if (Prop.UtopiaiaDcatExt.DATA_SOURCE_AVAILABILITY_ON_REQUEST.equalsIgnoreCase(typeValue)) {
