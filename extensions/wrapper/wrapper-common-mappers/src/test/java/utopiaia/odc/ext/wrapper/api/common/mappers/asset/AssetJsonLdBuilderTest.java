...
package utopiaia.odc.ext.wrapper.api.common.mappers.asset;

import utopiaia.odc.ext.wrapper.api.common.mappers.Factory;
import utopiaia.odc.ext.wrapper.api.common.model.DataSourceType;
import utopiaia.odc.ext.wrapper.api.common.model.SecretValue;
import utopiaia.odc.ext.wrapper.api.common.model.UiAssetCreateRequest;
import utopiaia.odc.ext.wrapper.api.common.model.UiDataSource;
import utopiaia.odc.ext.wrapper.api.common.model.UiDataSourceHttpData;
import utopiaia.odc.ext.wrapper.api.common.model.UiDataSourceHttpDataMethod;
...
import static utopiaia.odc.ext.wrapper.api.common.mappers.JsonAssertsUtils.assertEqualJson;
...
class AssetJsonLdBuilderTest {
    ...
    void test_create_httpData_methodParameterization() {
        ...
        var expectedProperties = dummyAssetCommonProperties()
            .add(Prop.UtopiaiaDcatExt.HttpDatasourceHints.METHOD, "true");
    ...
    void test_create_httpData_pathParameterization() {
        ...
        var expectedProperties = dummyAssetCommonProperties()
            .add(Prop.UtopiaiaDcatExt.HttpDatasourceHints.PATH, "true");
    ...
    void test_create_httpData_queryParameterization() {
        ...
        var expectedProperties = dummyAssetCommonProperties()
            .add(Prop.UtopiaiaDcatExt.HttpDatasourceHints.QUERY_PARAMS, "true");
    ...
    void test_create_httpData_bodyParameterization() {
        ...
        var expectedProperties = dummyAssetCommonProperties()
            .add(Prop.UtopiaiaDcatExt.HttpDatasourceHints.BODY, "true");
    ...
    void test_create_onRequest() {
        ...
        var dataAddress = Json.createObjectBuilder()
            ...
            .add(Prop.UtopiaiaDcatExt.DATA_SOURCE_AVAILABILITY, Prop.UtopiaiaDcatExt.DATA_SOURCE_AVAILABILITY_ON_REQUEST)
            .add(Prop.UtopiaiaDcatExt.CONTACT_EMAIL, "contact@example.com")
            .add(Prop.UtopiaiaDcatExt.CONTACT_PREFERRED_EMAIL_SUBJECT, "Test");

        var expectedProperties = dummyAssetCommonProperties()
            .add(Prop.UtopiaiaDcatExt.DATA_SOURCE_AVAILABILITY, Prop.UtopiaiaDcatExt.DATA_SOURCE_AVAILABILITY_ON_REQUEST)
            .add(Prop.UtopiaiaDcatExt.CONTACT_EMAIL, "contact@example.com")
            .add(Prop.UtopiaiaDcatExt.CONTACT_PREFERRED_EMAIL_SUBJECT, "Test")
            .remove(Prop.UtopiaiaDcatExt.HttpDatasourceHints.METHOD)
            .remove(Prop.UtopiaiaDcatExt.HttpDatasourceHints.PATH)
            .remove(Prop.UtopiaiaDcatExt.HttpDatasourceHints.QUERY_PARAMS)
            .remove(Prop.UtopiaiaDcatExt.HttpDatasourceHints.BODY);
    ...
    private JsonObjectBuilder dummyAssetCommonProperties() {
        return Json.createObjectBuilder()
            ...
            .add(Prop.UtopiaiaDcatExt.HttpDatasourceHints.METHOD, "false")
            .add(Prop.UtopiaiaDcatExt.HttpDatasourceHints.PATH, "false")
            .add(Prop.UtopiaiaDcatExt.HttpDatasourceHints.QUERY_PARAMS, "false")
            .add(Prop.UtopiaiaDcatExt.HttpDatasourceHints.BODY, "false");
    }
