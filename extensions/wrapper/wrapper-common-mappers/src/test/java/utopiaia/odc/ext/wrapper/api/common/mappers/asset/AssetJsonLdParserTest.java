...
import utopiaia.odc.ext.wrapper.api.common.mappers.TestUtils;
...
import static utopiaia.odc.ext.wrapper.api.common.mappers.JsonAssertsUtils.assertIsEqualExcludingPaths;
...
class AssetJsonLdParserTest {
    ...
    void test_createUiAsset_booleanParsing_badValue() {
        ...
        var assetJsonLd = createObjectBuilder()
            .add(Prop.ID, "my-asset-1")
            .add(Prop.Edc.PROPERTIES, createObjectBuilder()
                .add(Prop.UtopiaiaDcatExt.HttpDatasourceHints.METHOD, "wrongBooleanValue")
                .build())
            .build();
    ...
    void test_createUiAsset_booleanParsing_blankBooleanValue() {
        ...
        var assetJsonLd = createObjectBuilder()
            .add(Prop.ID, "my-asset-1")
            .add(Prop.Edc.PROPERTIES, createObjectBuilder()
                .add(Prop.UtopiaiaDcatExt.HttpDatasourceHints.METHOD, " ")
                .build())
            .build();
